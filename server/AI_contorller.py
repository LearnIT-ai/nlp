...
class AiController:
    ...
    def run_flat_t5(user_message):
        ...
        en_text = AiController.translate_m2m(clean_query_text, source_lang="uk", target_lang="en")
        ...
        uk_answer = AiController.translate_m2m(decoded_output, source_lang="en", target_lang="uk")
    ...
    def query_model_flan_t5(query_text: str):
        ...
        response_text = AiController.run_flat_t5(prompt)
    ...
    def main_flan_t5(user_message):
        ...
        while True:
            ...
            if user_input.lower() == "exit":
                ...
                break
            try:
                return AiController.query_model_flan_t5(user_input)
